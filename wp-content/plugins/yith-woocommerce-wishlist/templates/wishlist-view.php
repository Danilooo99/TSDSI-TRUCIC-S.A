...
<table
	...
	<tr>
		...
		<th class="product-name">
			<span class="nobr">
				<?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Nombre del alojamiento', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?>
			</span>
		</th>
...
?>
	...
	if ( $wishlist && $wishlist->has_items() ) :
		...
		?>
		<tr>
			<td colspan="<?php echo esc_attr( $column_count ); ?>" class="wishlist-empty"><?php echo esc_html( apply_filters( 'yith_wcwl_no_product_to_remove_message', __( 'No hay alojamientos añadidos a la lista de favoritos', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?></td>
		</tr>
		<?php
	endif;
