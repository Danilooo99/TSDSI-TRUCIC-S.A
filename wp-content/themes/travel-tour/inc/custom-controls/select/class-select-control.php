<?php
/**
 * Customizer Control: travel-tour-select.
 *
 */
...
if ( ! class_exists( 'Travel_Tour_Select_Control' ) ) {

	/**
	 * Select control.
	 */
	class Travel_Tour_Select_Control extends Wp_Customize_Control {

		public $type = 'travel-tour-select';
        ...
        public function enqueue() {
            ...
            wp_enqueue_script( 'travel-tour-select', get_template_directory_uri() . '/inc/custom-controls/select/select.js', array( 'jquery', 'selectize' ), false, true ); //for multi select    
        }
