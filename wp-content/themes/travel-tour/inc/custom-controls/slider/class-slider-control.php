...
if ( ! class_exists( 'Travel_Tour_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Travel_Tour_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'travel-tour-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'travel-tour-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
